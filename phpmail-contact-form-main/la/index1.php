<?php $pageTitle = "ກ່ຽວກັບໍລິສັດເທັກອາດ"; ?>
<!DOCTYPE html>
<html lang="lo">
<head>
    <meta charset="UTF-8">
    ...
    <section class="about-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="image-box">
                        <img src="../th/images/about.png" alt="ກ່ຽວກັບບໍລິສັດເທັກອາດ">
                    </div>
                </div>
                <div class="col-md-6">
                    <h2>ວິໄສທັດ ແລະ ພາລະກິດ</h2>
