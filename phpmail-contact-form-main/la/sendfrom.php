...
<body>
    ...
    <main class="containerbody">
        ...
        <form action="contact.php" method="POST" enctype="multipart/form-data" id="contactForm">
            ...
            <div class="form-group">
                <label for="fileUpload">ແນບໄຟລ໌ຂອງທ່ານ (ສູງສຸດ 5 ໄຟລ໌) <span class="required">*</span></label>
            ...
            <div class="language-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="phoneNumber" name="phoneNumber" placeholder="ເບີໂທຂອງທ່ານ" pattern="[0-9()+#-*]+" title="Only numbers and phone characters (+, #, -, *) are accepted.">
                </div>
            </div>
    ...
    <script>
        // JavaScript ດຽວກັນກັບທີ່ເຈົ້າໄດ້ໃຊ້ໄວ້
